...
//----------------------------------------------------------------------------------
//----------------------------------------------------------------------------------
int EdaParallel::Pop_sample(int word, int doc) {
...
//----------------------------------------------------------------------------------
//----------------------------------------------------------------------------------
void EdaParallel::Hide_topic(int t) {
    Eda::Hide_topic(t);
    ends.clear();
...
void EdaParallel::gibbs() {
    ...
    for(int i=0; i < P; i++ ){
        pair<EdaParallel *, int>* args = new pair<EdaParallel *, int>(this, i);
...
//----------------------------------------------------------------------------------
//----------------------------------------------------------------------------------
void EdaParallel::Populate_prob_thread(int id) {
...
//----------------------------------------------------------------------------------
//----------------------------------------------------------------------------------
void*EdaParallel::Populate_prob_thread_wrapper(void *args) {
    pair<EdaParallel *, int>* t = (pair<EdaParallel *, int>*)args;
...
//----------------------------------------------------------------------------------
//----------------------------------------------------------------------------------
EdaParallel::EdaParallel(EdaOptions options) : Eda(options) {
    end = false;
}
//----------------------------------------------------------------------------------
//----------------------------------------------------------------------------------