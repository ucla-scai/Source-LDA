...
//----------------------------------------------------------------------------------
//----------------------------------------------------------------------------------
int ConceptLdaParallel::Pop_sample(int word, int doc) {
...
//----------------------------------------------------------------------------------
//----------------------------------------------------------------------------------
void ConceptLdaParallel::Hide_topic(int t) {
    ConceptLda::Hide_topic(t);
    ends.clear();
...
void ConceptLdaParallel::gibbs() {
    ...
    for(int i=0; i < P; i++ ){
        pair<ConceptLdaParallel *, int>* args = new pair<ConceptLdaParallel *, int>(this, i);
...
//----------------------------------------------------------------------------------
//----------------------------------------------------------------------------------
void ConceptLdaParallel::Populate_prob_thread(int id) {
...
//----------------------------------------------------------------------------------
//----------------------------------------------------------------------------------
void*ConceptLdaParallel::Populate_prob_thread_wrapper(void *args) {
    pair<ConceptLdaParallel *, int>* t = (pair<ConceptLdaParallel *, int>*)args;
...
//----------------------------------------------------------------------------------
//----------------------------------------------------------------------------------
ConceptLdaParallel::ConceptLdaParallel(ConceptLdaOptions options) : ConceptLda(options) {
    end = false;
}
//----------------------------------------------------------------------------------
//----------------------------------------------------------------------------------